...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){                 // here i am using multi-threading
       
        String [] text = new String[]{"JWS Marriott Hotel", "Maddrin Oriental Hotel", "Four Seasond Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "The Taj Hotel", "Breeze Blow Hotel", "Happy Morning Motel", "River View Hotel", };
        try{
             for(int i = 0; i<= 9; i++){
