...
public class Dashboard extends JFrame implements ActionListener {
    ...
    JButton viewpackages, viewhotels, destination, bookhotel, viewBookedHotel, payments, calculators, notepad, about;
    Dashboard(String username){
        ...
        JLabel imagc= new JLabel(i6);
        imagc.setBounds(0,0,1650,1000);
        add(imagc);
